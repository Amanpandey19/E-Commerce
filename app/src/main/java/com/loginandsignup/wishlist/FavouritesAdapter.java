...
public class FavouritesAdapter extends RecyclerView.Adapter<FavouritesAdapter.RecyclerviewHolder> {
    ...
    public FavouritesAdapter(Context context, ArrayList<product_item_cart> product_item_cartArrayList) {
    ...
    public RecyclerviewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View mRootView = LayoutInflater.from(parent.getContext()).inflate(R.layout.favourite_item, parent, false);
